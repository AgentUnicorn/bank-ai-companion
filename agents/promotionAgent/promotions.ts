    ...
    promotions: [
        {
            ...
            offer: {
                discount: "12%",
                cap: "tối đa 50 đô la Mỹ (~1.250.000 VND)",
                details: [
                    {
                        region: "Nhật Bản",
                        rate: "12%"
            ...
            conditions: [
                "Ưu đãi áp dụng cho tất cả thẻ JCB phát hành tại Việt Nam.",
                "Ưu đãi có số lượng giới hạn và được áp dụng theo nguyên tắc ai đặt trước được trước.",
                "Việc đặt phòng phải được thực hiện thông qua trang web dành riêng cho chương trình.",
                "Khuyến mãi được áp dụng cho các khách sạn chấp nhận thanh toán trả trước có thể hiện dòng chữ \"Đã áp dụng JCB Vietnam Discount\".",
                "Phần giảm giá sẽ được thể hiện tại bước “Chi tiết thanh toán” sau khi chủ thẻ JCB đăng nhập số thẻ hợp lệ. Phần giá trị giảm thể hiện trước dòng thuế & phí dịch vụ của khách sạn & được áp dụng trước khi xác nhận giá cuối cùng của đơn đặt phòng.",
                "Ưu đãi không áp dụng cho các giao dịch với hình thức thanh toán trực tiếp tại khách sạn (“Pay at the Hotel”).",
                "Ưu đãi chỉ áp dụng cho giá phòng, không bao gồm thuế, phí dịch vụ, các khoản phụ thu và chi phí cá nhân.",
            ...
            offer: {
                ...
                details: [
                    ...
                    },
                    {
                        ...
                        description: "Hoàn 10% tối đa 200,000 đồng/tháng cho giao dịch tại Thế Giới Di Động (Điện Máy Xanh, Thế Giới Di Động, Topzone) và Hoàn 10% tối đa 300,000 đồng/tháng cho giao dịch tại siêu thị và cửa hàng tiện lợi lớn"
                    },
                    {
                        condition: "Tổng giá trị giao dịch kỳ sao kê trước < 10 triệu đồng",
                        description: "Hoàn 1% cho giao dịch tại Thế Giới Di Động (Điện Máy Xanh, Thế Giới Di Động, Topzone) và Hoàn 1% cho giao dịch tại siêu thị và cửa hàng tiện lợi lớn"
                    }
                ]
            },
            valid_period: {
        ...
        },
        {
            ...
            offer: {
                ...
                details: [
                    {
                        min_order: "50.000 VNĐ",
                        rate: "20.000 VNĐ"
                    },
                    {
                        min_order: "100.000 VNĐ",
                        rate: "50.000 VNĐ"
                    }
                ]
            },
        ...
        },
        {
            ...
            card_type: "JCB",
            offer: {
                discount: "tới 500.000 VND",
                cap: "",
                details: [
                    {
                        service: "Vé máy bay khứ hồi Việt Nam - Nhật Bản",
                        rate: "500.000 VND"
                    },
                    {
                        service: "Phòng khách sạn tại Nhật Bản",
                        rate: "200.000 VND"
                    },
                    {
                        service: "Vé vui chơi & tour từ 1 triệu VND tại Nhật Bản",
                        rate: "100.000 VND"
                    }
                ]
            },
            ...
            applicable_area: "Nhật Bản",
            conditions: [
                "Ưu đãi áp dụng cho tất cả thẻ JCB phát hành tại Việt Nam",
                "Ưu đãi có số lượng giới hạn và được áp dụng theo nguyên tắc ai đặt trước được trước",
                "Việc đặt dịch vụ phải được thực hiện thông qua trang web Traveloka",
        ...
        },
        {
            ...
            offer: {
                ...
                details: [
                    {
                        rate: "lãi suất từ 5.2%/năm"
                    },
                    {
                        fixed_period: "thời gian cố định lãi suất linh hoạt đến 24 tháng"
                    },
                    {
                        term: "thời hạn vay lên đến 25 năm"
                    },
                    {
                        early_repayment_fee: "phí trả nợ trước hạn không quá 2.5%, miễn phí từ năm thứ 5"
                    },
                    {
                        process: "thủ tục đơn giản, duyệt vay nhanh chóng chỉ trong 1 phút"
                    }
                ]
            },
            valid_period: {
        ...
        },
        {
            ...
            offer: {
                ...
                details: [
                    {
                        rate: "7.9%/năm",
                        condition: "DÒNG XE ĐIỆN (EV): LTV ≤ 75%"
                    },
                    {
                        rate: "8.2%/năm",
                        condition: "DÒNG XE ĐIỆN (EV): 75% < LTV ≤ 80%"
                    },
                    {
                        rate: "7.7%/năm",
                        condition: "DÒNG XE HYBRID: LTV ≤ 80%"
                    },
                    {
                        rate: "7.9%/năm",
                        condition: "DÒNG XE HYBRID: 80% < LTV ≤ 85%"
                    }
                ]
            },
            valid_period: {
                start_date: "07/02/2025",
                end_date: "31/12/2025"
            },
            applicable_area: "Toàn quốc",
            conditions: [
                "Đối tượng khách hàng: Toàn bộ khách hàng",
                "Lãi suất cố định trong 12 tháng đầu",
                "Hạn mức vay lên đến 80% giá trị xe",
                "Kỳ hạn vay từ 48-96 tháng",
                "Chứng minh tài chính linh hoạt",
        ...
        },
        {
            ...
            applicable_area: "Toàn quốc",
            conditions: [
                "Áp dụng tại các nhà hàng Michelin được chỉ định",
                "Stoker: 44 Mạc Thị Bưởi Street, Bến Nghé Ward, District 1, Ho Chi Minh City.",
